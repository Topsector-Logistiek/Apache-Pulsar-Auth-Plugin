...
public class AuthenticationProviderCustomToken implements AuthenticationProvider {
    ...
    private Jwt<?, Claims> authenticateTokenIshare(final String token) throws AuthenticationException {
        try {
    ...
    private static final class TokenAuthenticationState implements AuthenticationState {
        private final AuthenticationProviderCustomToken provider;
        ...
        TokenAuthenticationState(
                AuthenticationProviderCustomToken provider,
                AuthData authData,
